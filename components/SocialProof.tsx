...
function N8nIcon({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
      <path d="M12.8 2.4c-1.6 0-3.2.4-4.4 1.2L3.6 6.8c-1.6 1.2-2.4 3.2-2 5.2.4 2 2 3.6 4 4l4.8 1.2c.8.4 1.2 1.2.8 2-.4.8-1.2 1.2-2 .8l-4.8-1.2c-.4 0-.8.4-.8.8s.4.8.8.8l4.8 1.2c2 .4 4-.4 5.2-2 1.2-1.6 1.2-4 0-5.6L10 9.6c-.8-.4-1.2-1.2-.8-2 .4-.8 1.2-1.2 2-.8l4.4 2.4c2.4 1.2 5.2.4 6.4-2 1.2-2.4.4-5.2-2-6.4L15.6 3c-1.2-.4-2-.6-2.8-.6z"/>
    </svg>
  );
}
...
const tools = [MakeIcon, N8nIcon, SlackIcon, GitHubIcon, MessengerIcon, NotionIcon, GoogleSheetsIcon, HubSpotIcon, GmailIcon, WhatsAppIcon];

export function SocialProof() {
  return (
    <div className="w-full border-y border-white/5 relative overflow-hidden bg-black/80">
      <div className="py-12 relative">
        <p className="text-center text-xs font-medium uppercase tracking-[0.2em] text-neutral-500 mb-8 px-6">
          Funktioniert mit deinen Tools
        </p>
        <div className="overflow-hidden">
          <div className="flex gap-12 w-max animate-marquee">
            {[...tools, ...tools, ...tools, ...tools].map((Icon, i) => (
              <div key={i} className="w-20 h-20 shrink-0 rounded-2xl bg-neutral-900 border border-white/10 flex items-center justify-center">
